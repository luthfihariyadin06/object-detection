...
class MaskRCNN:
    def __init__(self):
        # Loading Mask RCNN
        self.net = cv2.dnn.readNetFromTensorflow("yolo_with_tensor_flow/dnn/frozen_inference_graph_coco.pb",
                                            "yolo_with_tensor_flow/dnn/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt")
        ...
        self.classes = []
        with open("yolo_with_tensor_flow/dnn/classes.txt", "r") as file_object:
    ...
    def draw_object_info(self, bgr_frame, depth_frame):
        ...
        for box, class_id, obj_center in zip(self.obj_boxes, self.obj_classes, self.obj_centers):
            ...
            cv2.putText(bgr_frame, class_name.capitalize() + position, (x + 5, y + 25), 0, 0.8, (255, 255, 255), 2)
    ...
    def draw_object_info_new(self, bgr_frame):
        # loop through the detection
        for box, class_id, obj_center in zip(self.obj_boxes, self.obj_classes, self.obj_centers):
            x, y, x2, y2 = box
